...
`Create an interactive HTML table to explore the data for top genres, years, and titles`
...
kable(rmse_results, "html") %>%
  ...
  column_spec(2, bold = TRUE, color = "black", background = "#ffd79c") %>%
  column_spec(3, bold = TRUE, color = "black", background = "#ff9e8f") %>%
  column_spec(4, bold = TRUE, color = "black", background = "#2bffca") %>%
...
kable(rmse_results_reco, "html") %>%
  ...
  column_spec(1, bold = TRUE, color = "black") %>%
  column_spec(2, bold = TRUE, color = "black", background = "#2bffca") %>%
  row_spec(0, extra_css = "text-align: left;") %>%
...
grouped_recommendations %>% 
  ...
  column_spec(1, width = "300px") %>%  # Adjust column width for Title column
  scroll_box(width = "100%", height = "100%")  # Make table scrollable if too wide
